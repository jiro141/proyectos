  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
      <div className="w-full max-w-sm sm:max-w-md">
        <form onSubmit={handleSubmit} className="relative bg-cover bg-center bg-[url('/fondo.jpeg')] p-6 sm:p-8 md:p-10 rounded-lg shadow-md border border-gray-700 overflow-hidden">
          {/* Overlay dentro del form */}
